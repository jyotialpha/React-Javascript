          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-lg mb-4 h-48">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
